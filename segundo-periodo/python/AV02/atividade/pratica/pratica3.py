#programa em python que simula uma calculadora simples, permitindo realizar as quatro operações básicas (soma, subtração, multiplicação e divisão) e tratando entradas inválidas.
